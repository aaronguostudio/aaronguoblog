...
📎 **[Download: AMZN DCF Model (Excel)](/blog-assets/AMZN_DCF_Model_2026-02-25.xlsx)** — actual output from `/dcf AMZN`, unedited after generation
...
📎 **[Download: Client Performance Report (Excel)](/blog-assets/Sample_Customer_Performance_Report_FY2025.xlsx)** — actual output from the client report command, real test run
...
📎 **[Download: Investment Proposal (Markdown)](/blog-assets/Guo_Aaron_Investment_Proposal.md)** — actual skill output for a sample client profile, unedited
...
![The Blueprint — AI-native financial firm architecture: institutional knowledge in skill files, core infrastructure with specialist modules, data connectors feeding from below, outputs to Excel/PowerPoint/Word](/blogs-img/2026-02-26-anthropic-finance-09.jpg)
...
| File                                                                                     | Format   | Section                             |
| ---------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| [AMZN DCF Model](/blog-assets/AMZN_DCF_Model_2026-02-25.xlsx)                            | Excel    | I Actually Ran It                   |
| [Client Performance Report](/blog-assets/Sample_Customer_Performance_Report_FY2025.xlsx) | Excel    | I Actually Ran It                   |
| [Investment Proposal](/blog-assets/Guo_Aaron_Investment_Proposal.xlsx)                   | Excel    | From Agentic Workflow to Skill File |
| [Investment Proposal](/blog-assets/Guo_Aaron_Investment_Proposal.md)                     | Markdown | From Agentic Workflow to Skill File |

---

_I write about building AI-native at the intersection of financial services and tech product — what it actually looks like from inside a firm. Newsletter below:_

_→ [Ship with AI on Beehiiv](https://shipwithai.beehiiv.com)_
